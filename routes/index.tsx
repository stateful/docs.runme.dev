      ...
      <div class='min-h-screen 2xl:min-h-[50vh]'>
        <div class='z-[100] text-white max-w-[1440px] mx-auto'>
          ...
          <div class='px-12 py-2 pt-32 flex flex-col lg:flex-row space-y-12 lg:space-x-12 lg:space-y-0'>
            ...
            <img src='/runme-website-commands.gif' class='object-cover scale-105 z-10 h-auto sm:max-w-xl xl:max-w-[720px] z-10' />
          </div>
        </div>
        <div class="px-12 py-6 flex flex-col items-center mt-24 lg:mt-[24vh]">
          ...
          <div class="flex flex-col-reverse lg:flex-row justify-between mt-12 space-y-10 lg:space-y-0 lg:space-x-12 2xl:space-x-24">
            <img src="/markdown-original.png" alt="Shell running markdown files commands" class="object-cover object-left mt-12 lg:mt-0 sm:max-w-xl xl:max-w-[700px]" />
            <div class="text-2xl">
              <p>Write your markdown and any code blocks with `sh` will be read as runnable commands.</p>
