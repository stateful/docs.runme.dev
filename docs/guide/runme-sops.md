...
```bash {"id":"01HRSMKKZDSRYQ5GAQ045JZWRQ"}
aws configure
```
...
```sh {"id":"01HRSMKKZDM2RP1Y8JZ47N61EW"}
...
```sh {"id":"01HRSMKKZDZ8682SQNHQAE5RF1"}
...
```sh {"id":"01HRSMKKZDT1MF5M35W0K6BJK3"}
...
```sh {"id":"01HRSMKKZDT87QCCDJJ2Y4T4RB"}
echo "creation_rules
...
```bash {"id":"01HRSMKKZD6ME7FZKS477ZM5JB"}
cat ~/.sops.yaml
```
...
```yaml {"id":"01HRSMKKZD0JTC5K0W3VAAXGCY"}
...
```yaml {"id":"01HRSMKKZDHCMPKG98AE2SABKW"}
...
kubectl apply -f mysealedsecret.yam
```
