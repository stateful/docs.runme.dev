...
Learn how to install Runme and [get started](https://docs.runme.dev/getting-started/).
...
- **[Runme CLI](https://docs.runme.dev/getting-started/cli)**. Understands markdown, discovers command blocks, and offers a guided terminal UI to execute command blocks and individual subcommands for power usage and CI/CD.
...
- **[Runme for VS Code](https://docs.runme.dev/getting-started/vs-code)** first-party integration into VS Code. Allows execution of command blocks from code editor and notebook UI. The notebook UI offers a rich viewing, execution, and authoring experience leveraging web-app-like features.
- **[Runme for Web](https://docs.runme.dev/getting-started/web)** is a self-contained web app version of Runme you can run locally. Mirrors VS Code's Notebook & Editor UX without running the IDE.
