    ...
    <footer class="p-24 max-w-[1440px] mx-auto 2xl:px-0">
      <div class="flex flex-col lg:flex-row space-y-4 lg:space-y-0 justify-between">
        <div class="space-y-2">
          ...
          <p class="font-medium text-transparent text-xl bg-clip-text bg-gradient-to-r from-purple-500 to-pink-600">
        ...
        <div>
          ...
          <ol class="text-xl space-y-2">
            <li>
              <a
                class="text-gray-300 hover:underline text-xl"
                href="https://www.stateful.com/"
              >
                Website
              </a>
            </li>
