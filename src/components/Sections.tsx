...
export function Documentation() {
  return (
    <div className="px-1 my-32 flex flex-col items-center justify-center text-center text-[color:var(--ifm-font-color-base)]">
      ...
      <div className="flex gap-16 w-2/3 mb-20">
        <svg className="flex-row" width="125" height="125" viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex-row text-left">
          ...
          <p className="text-xl pt-4">
            Click <a href="vscode:extension/stateful.runme" className="p-2 mx-2 border border-solid border-purple-600 text-purple-600 hover:text-purple-600 rounded">Install Extension</a> to add Runme to your VS Code.
          </p>
        </div>
      </div>
      <div className="flex gap-16 w-2/3 mb-20">
        ...
        <div className="flex-row text-left">
          ...
          <p className="text-xl pt-4">
            Add a <span className="p-2 mx-2 border border-solid border-blue-600 text-blue-600 rounded">background</span> annotation to run a task in the background.
          </p>
        </div>
      </div>
      <div className="flex gap-16 w-2/3 mb-20">
        ...
        <div className="flex-row text-left">
          ...
          <p className="text-xl pt-4">
            Read our <a href="https://github.com/stateful/vscode-runme/blob/main/CONTRIBUTING.md" className="p-2 mx-2 border border-solid border-red-600 text-red-600 hover:text-red-600 rounded">Contributing Guidelines</a> for more information.
          </p>
        </div>
      </div>
    </div>
